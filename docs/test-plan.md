...
monoceros --help           # Listing aller 12 Subcommands
```
...
| --- | ------------------------------- | ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| A.1 | Alle 12 Subcommands registriert | `monoceros --help`             | Listing mit `create`, `shell`, `run`, `logs`, `start`, `stop`, `down`, `status`, `apply`, `add-service`, `add-language`, `add-apt-packages` | Task 1    |
...
**Fail-Bedeutung:** wenn A.1 nicht alle 12 zeigt, ist die
...
- B.13–B.23 fehlerhaft → Mutator-Logik in
