...
monoceros --help           # Listing aller 14 Subcommands
```
...
| --- | ------------------------------- | ------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| A.1 | Alle 14 Subcommands registriert | `monoceros --help`             | Listing mit `create`, `shell`, `run`, `logs`, `start`, `stop`, `down`, `status`, `apply`, `add-service`, `add-language`, `add-apt-packages`, `add-feature`, `add-from-url` | Task 1    |
...
**Fail-Bedeutung:** wenn A.1 nicht alle 14 zeigt, ist die
...
- B.13–B.34 fehlerhaft → Mutator-Logik in
