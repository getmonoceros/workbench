...
monoceros --help           # Listing aller 13 Subcommands
```
...
| --- | ------------------------------- | ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | --------- |
| A.1 | Alle 13 Subcommands registriert | `monoceros --help`             | Listing mit `create`, `shell`, `run`, `logs`, `start`, `stop`, `down`, `status`, `apply`, `add-service`, `add-language`, `add-apt-packages`, `add-feature` | Task 1    |
...
**Fail-Bedeutung:** wenn A.1 nicht alle 13 zeigt, ist die
...
- B.13–B.28 fehlerhaft → Mutator-Logik in
