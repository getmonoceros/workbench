---
name: monoceros-ship
description: 'Implement an approved plan file and review the result against it. Runs the implementer, gates on the acceptance command, then the reviewer, and repairs at most twice.'
